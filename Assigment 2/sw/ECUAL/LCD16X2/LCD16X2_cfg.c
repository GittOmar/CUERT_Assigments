...
const LCD16X2_CfgType LCD16X2_CfgParam[LCD16X2_MAX] =
{
	{   /*  Configuration Parameter For LCD Instance #1   */
		...
		GPIOA,	GPIO_PIN_13, /* LCD D4 Pin GPIO Port & Pin */
		GPIOA,	GPIO_PIN_12, /* LCD D5 Pin GPIO Port & Pin */
		GPIOA,	GPIO_PIN_11, /* LCD D6 Pin GPIO Port & Pin */
		GPIOA,	GPIO_PIN_10, /* LCD D7 Pin GPIO Port & Pin */
		GPIOA,	GPIO_PIN_8, /* LCD EN Pin GPIO Port & Pin */
